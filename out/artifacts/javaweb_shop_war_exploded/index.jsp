            ...
            <div class="row mb-4">
              <div class="col-md-4">
                <div class="box clickable d-flex flex-column justify-content-center mb-0 h-100">
                  ...
                  <h3><a href="aboutUs.jsp">We love our customers</a></h3>
              ...
              <div class="col-md-4">
                <div class="box clickable d-flex flex-column justify-content-center mb-0 h-100">
                  ...
                  <h3><a href="aboutUs.jsp">Best prices</a></h3>
              ...
              <div class="col-md-4">
                <div class="box clickable d-flex flex-column justify-content-center mb-0 h-100">
                  ...
                  <h3><a href="aboutUs.jsp">100% satisfaction guaranteed</a></h3>
        ...
        <div class="box text-center">
          <div class="container">
            <div class="col-md-12">
              ...
              <p class="lead mb-0">The motto of jj's shop: <a href="aboutUs.jsp#MusicMakesLife">Music Makes Life</a></p>
            </div>
          </div>
        </div>
        <div class="container">
          <div class="col-md-12">
            <div id="blog-homepage" class="row">
              <div class="col-sm-6">
                <div class="post">
                  <h4><a href="aboutUs.jsp#LearningthePiano">What Are the Requirements for Learning the Piano?</a></h4>
                  <hr>
                  <p class="intro">
                  There is no perfect person in the world, everyone has their own areas 
                of expertise and weaknesses. So for learning the piano, how to judge 
                whether it is suitable for learning the piano? What are the ideal conditions 
                for learning the piano?
                  </p>
                  <p class="read-more"><a href="aboutUs.jsp#LearningthePiano" class="btn btn-primary">Read more</a></p>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="post">
                  <h4><a href="aboutUs.jsp#ChooseaPiano">How to Choose a Piano?</a></h4>
                  <hr>
                  <p class="intro">
                ...
                of timbre, touch, tuning stability, durability, appearance and tension.
                  ...
                  <p class="read-more"><a href="aboutUs.jsp#ChooseaPiano" class="btn btn-primary">Read more</a></p>
                </div>
              </div>
            </div>
            <!-- /#blog-homepage-->
