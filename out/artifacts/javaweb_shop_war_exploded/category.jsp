...
<!-- Cart -->            
          ...
          <div id="navigation" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item"><a href="category.jsp" class="nav-link active">Piano</a></li>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-9">
              <div class="box">
                <h1>Piano</h1>
                <p>In this page, we provide you with all kinds of pianos, you can definitely find the one you need here.</p>
              </div>
              ...
              <%
                ...
                ArrayList<Commodity> list = commodityDao.findByType("piano");
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="flip-container">
                      <div class="flipper">
                        <div class="front"><a href="detail.jsp?username=<%=username%>&id=<%=commodity.getCommodityid()%>"><img src="img/<%=commodity.getImg() %>" alt="" class="img-fluid"></a></div>
                        <div class="back"><a href="detail.jsp?username=<%=username%>&id=<%=commodity.getCommodityid()%>"><img src="img/<%=commodity.getImg() %>" alt="" class="img-fluid"></a></div>
                      </div>
                    </div><a href="detail.jsp?id=<%=commodity.getCommodityid() %>" class="invisible"><img src="img/<%=commodity.getImg() %>" alt="" class="img-fluid"></a>
                    <div class="text">
                      <h3><a href="detail.jsp?id=<%=commodity.getCommodityid() %>"><%=commodity.getCommodityname() %></a></h3>
                      <p class="price">
                        <del></del>$<%=commodity.getPrice() %>
                      </p>
                      <p class="buttons"><a href="detail.jsp?id=<%=commodity.getCommodityid() %>" class="btn btn-outline-secondary">View detail</a></p>
                    </div>
                    <!-- /.text-->
                  </div>
                  <!-- /.product            -->
