              ...
              <div class="card sidebar-menu">
                ...
                <div class="card-body">
                  <ul class="nav nav-pills flex-column">
                    <a href="customer-account.jsp" class="nav-link active"><i class="fa fa-user"></i> My account</a>
                    <a href="customer-orders.jsp" class="nav-link"><i class="fa fa-list"></i> My orders</a>
                    <a href="logout.jsp" class="nav-link"><i class="fa fa-sign-out"></i> Logout</a>
                  </ul>
                </div>
              </div>
              <!-- /.col-lg-3-->
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <% String telephone = nowUser.getTelephone(); %>
