...
<!-- Cart -->            
        ...
        <div id="navigation" class="collapse navbar-collapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item"><a href="accordition.jsp" class="nav-link active">Accordion</a></li>
      ...
      <div class="container">
        <div class="row">
            <div class="col-lg-9">
              <div class="box">
                <h1>Accordion</h1>
                <p>In this page, we provide you with all kinds of accordions, you can definitely find the one you need here.</p>
              </div>
              ...
              <%
                ...
                ArrayList<Commodity> list = commodityDao.findByType("accordion");
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="product">
                    <div class="flip-container">
                      <div class="flipper">
                        <div class="front"><a href="detail.jsp?id=<%=commodity.getCommodityid() %>"><img src="img/<%=commodity.getImg() %>" alt="" class="img-fluid"></a></div>
                        <div class="back"><a href="detail.jsp?id=<%=commodity.getCommodityid() %>"><img src="img/<%=commodity.getImg() %>" alt="" class="img-fluid"></a></div>
                      </div>
