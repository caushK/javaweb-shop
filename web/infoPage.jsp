            ...
            <div class="col-lg-12">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li aria-current="page" class="breadcrumb-item active">Information</li>
                </ol>
              </nav>
              <div id="error-page" class="row">
                <div class="col-md-6 mx-auto">
                  <div class="box text-center py-5">
                    <p class="text-center"><img src="img/logo.png" alt="jj template"></p>
                    <h3> </h3>
                    <%String info = (String)session.getAttribute("info"); %>
                    <h3><%= info %></h3>
                    <p class="buttons"><a href="index.jsp" class="btn btn-primary"><i class="fa fa-home"></i> Go to Homepage</a></p>
                  </div>
                </div>
              </div>
            </div>
