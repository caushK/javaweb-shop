...
<!-- Cart -->            
        ...
        <div id="navigation" class="collapse navbar-collapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item"><a href="electronic organ.jsp" class="nav-link active">Electronic piano</a></li>
        ...
        <div class="row">
            ...
            <div class="row products">
              ...
              <%
                ...
                ArrayList<Commodity> list = commodityDao.findByType("electronic organ");
